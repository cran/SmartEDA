...
ExpNumViz(data,target=NULL,nlim=5,fname=NULL,col=NULL,theme=theme,Page=c(2,2),sample=sn)
```
...
ExpCatViz(data,target=NULL,clim=10,margin=2,theme=theme,Page = c(2,2),sample=sc)
```
